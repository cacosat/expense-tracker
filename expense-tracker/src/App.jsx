...
function App() {
  ...
  <div id='test' className='flex flex-col items-center'>
    <div className={`flex flex-col items-center gap-12 max-w-[${appWidth}]`}>
      <Header width={appWidth} totalExpense='$2.157.020' iconLocation="./assets/plus-circle.svg" />
